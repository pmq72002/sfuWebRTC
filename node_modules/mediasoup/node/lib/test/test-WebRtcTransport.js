...
test('WebRtcTransport events succeed', async () => {
    ...
    let notificationOffset = notification_1.Notification.createNotification(builder, builder.createString(transport.id), notification_1.Event.WEBRTCTRANSPORT_ICE_STATE_CHANGE, notification_1.Body.WebRtcTransport_IceStateChangeNotification, iceStateChangeNotification.pack(builder));
    ...
    channel.emit(transport.id, notification_1.Event.WEBRTCTRANSPORT_ICE_STATE_CHANGE, notification);
    ...
    const iceSelectedTupleChangeNotification = new FbsWebRtcTransport.IceSelectedTupleChangeNotificationT(new FbsTransport.TupleT(iceSelectedTuple.localIp, iceSelectedTuple.localPort, iceSelectedTuple.remoteIp, iceSelectedTuple.remotePort, (0, Transport_1.serializeProtocol)(iceSelectedTuple.protocol)));
    notificationOffset = notification_1.Notification.createNotification(builder, builder.createString(transport.id), notification_1.Event.WEBRTCTRANSPORT_ICE_SELECTED_TUPLE_CHANGE, notification_1.Body.WebRtcTransport_IceSelectedTupleChangeNotification, iceSelectedTupleChangeNotification.pack(builder));
    builder.finish(notificationOffset);
    notification = notification_1.Notification.getRootAsNotification(new flatbuffers.ByteBuffer(builder.asUint8Array()));
    channel.emit(transport.id, notification_1.Event.WEBRTCTRANSPORT_ICE_SELECTED_TUPLE_CHANGE, notification);
    ...
    notificationOffset = notification_1.Notification.createNotification(builder, builder.createString(transport.id), notification_1.Event.WEBRTCTRANSPORT_DTLS_STATE_CHANGE, notification_1.Body.WebRtcTransport_DtlsStateChangeNotification, dtlsStateChangeNotification.pack(builder));
    builder.finish(notificationOffset);
    notification = notification_1.Notification.getRootAsNotification(new flatbuffers.ByteBuffer(builder.asUint8Array()));
    channel.emit(transport.id, notification_1.Event.WEBRTCTRANSPORT_DTLS_STATE_CHANGE, notification);
